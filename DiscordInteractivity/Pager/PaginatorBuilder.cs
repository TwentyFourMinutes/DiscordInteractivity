...
public class PaginatorBuilder
{
    ...
    {
        if (
            PaginatorFooter.HasFlag(PaginatorFooter.PaginatorAuthor)
            && PaginatorFooter.HasFlag(PaginatorFooter.BotAuthor)
        )
        {
            throw new InvalidOperationException(
                "You can not have the Paginator to display the BotAuthor and PaginatorAuthor at once!"
            );
        }
